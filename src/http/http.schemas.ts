...
// Derived types for API contract results, allowing extraction of data and error types
// from a union of success and error responses, facilitating type-safe handling of API responses in client code.
