...
export type { UnofficialStatusCode } from 'hono/utils/http-status';
...
export type SuccessResponseStatus = (typeof SUCCESS_RESPONSE_STATUSES)[number] | UnofficialStatusCode;
...
export type ErrorResponseStatus = (typeof ERROR_RESPONSE_STATUSES)[number] | UnofficialStatusCode;
